...
class _PageOnboarding4State extends State<PageOnboarding4> {
  ...
  Widget build(BuildContext context) {
    final pages = [
      ...
      viewcomponent(
          context: context,
          colorFondo: Color.fromRGBO(107, 162, 64, 1.0),
          assetImage: AssetImage("assets/imagenf4.png"),
          titulo2: "Malefica ",
          titulo1: "Disney",
          subtitulo: "Madrina de ----",
          isDark: false),
      viewcomponent(
          context: context,
          colorFondo: Color.fromRGBO(0, 0, 80, 1.0),
          assetImage: AssetImage("assets/imagenf3.png"),
